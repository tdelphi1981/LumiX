...
def populate_database(database_url: str = "sqlite:///production_sensitivity.db"):
    """Populate database with large-scale multi-period planning data using ORM."""
    print("=" * 80)
    print("PRODUCTION PLANNING DATABASE SETUP - STEP 4 (LARGE-SCALE with ORM)")
    print("=" * 80)
    ...
    try:
        ...
        print("=" * 80)
        print("\nNext step: Run 'python production_scaled.py' to solve large-scale optimization")
        print()
...
if __name__ == "__main__":
    populate_database("sqlite:///production_sensitivity.db")
